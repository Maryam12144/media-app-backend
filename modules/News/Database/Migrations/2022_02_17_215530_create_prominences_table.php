...
class CreateProminencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['prominences'], function (Blueprint $table) use ($tableNames) {
    ...
    {
        $tableNames = config('news.table_names');
        Schema::dropIfExists($tableNames['prominences']);
    }
}
