...
class CreateGeographicalCriteriasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['geographical_criterias'], function (Blueprint $table) use ($tableNames) {
    ...
    {
        $tableNames = config('news.table_names');
        Schema::dropIfExists($tableNames['geographical_criterias']);
    }
}
