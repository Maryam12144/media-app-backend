...
class CreateHumanInterestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['human_interests'], function (Blueprint $table) use ($tableNames) {
    ...
    {
        $tableNames = config('news.table_names');
        Schema::dropIfExists($tableNames['human_interests']);
    }
}
