...
<head>
    ...
    <link rel="stylesheet" href="/modules/news/kanactIslamabad/style.css">
...
<body>
    <div class="main-wrapper">
        ...
        <div class="footer">
            <div class="logo-wrap">
                <img src="/modules/news/kanactIslamabad/images/main-logo.gif" class="logo" alt="">
                <span id="time"></span>
            </div>
            <div class="ticker-wrap" id="ticker">
                <div class="breakingTicker  animatedBreaking" id="breakingVideo">
                    <img src="/modules/news/kanactIslamabad/images/breakingNewsTicker-new.gif" alt="">
                </div>
                <div class="onlyTicker animatedBreaking">
                    <img src="/modules/news/kanactIslamabad/images/Main Ticker.png"
            ...
            <div class="followUs" id="footer">
                <img src="/modules/news/kanactIslamabad/images/FollowUsTicker-new.png" />
            </div>
