...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/modules/news/karoobar/style.css">
...
<img src="/modules/news/karoobar/images/main-logo.gif" class="logo" alt="">
   ...
   <div class="footer">
    <div class="logo-wrap">
        ...
        <div class="breakingTicker  animatedBreaking" id="breakingVideo">
                <img src="/modules/news/karoobar/images/breakingNewsTicker-new.gif" alt="">
            </div>
            
            <div class="onlyTicker animatedBreaking">
                <img src="/modules/news/karoobar/images/ticker-red-new.png" class="ticker tick tickerBG ticker-red breakingTick" alt="">
                <img src="/modules/news/karoobar/images/ticker-blue-new.png" class=" ticker tick tickerBG ticker-blue breakingTick" alt="">
        ...
        <div class="followUs" id="footer" >
            <img src="/modules/news/kanactPakistan/images/FollowUsTicker-new.png" />
        </div>
        <div  class="followMarquee" >Kanact is changing the face of media with 100 Channels reaching out to 160 democratic countries with their local content in 10 languages, providing unbiased news, views, entertainment and information content. Kanact media is a platform designed to operate without any discrimination to nationalities, religions, ethnicities and business interests.</div>
    </div>
    </div>
