...
<body>
    ...
    <div class="main-wrapper">
        ...
        <video class="mainVideo" preload src="" id="secondVideo"  muted
            crossorigin
            playsinline
        ...
        <div class="footer">
            ...
            <div class="ticker-wrap" id="ticker">
                ...
                <div class="onlyTicker animatedBreaking">
                    ...
                    <div class="breakingTickerScroll" id="breakingTickerShow">
                        <ul class="ticker-text" id="breakingTickerRed">
                            <li>ملک میں گزشتہ ایک ہفتے میں پیٹرولیم مصنوعات کی قیمتوں میں 60 روپے فی لیٹر اضافہ ہوا ہے
                            </li>
                            <li>م 6 ماہ آئی ایم ایف کے سامنے کھڑے رہے لیکن موجودہ حکومت آئی ایم ایف کی شرائط کی وجہ سے
                                قیمتیں بڑھا رہی ہے: سینیٹر شوکت ترین</li>
                            <li>گزشتہ ایک ہفتے میں پیٹرولیم مصنوعات کی قیم فی لیٹر اضافہ ہوا ہے
                            </li>
                        </ul>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let videoLoop = () => {
                        ...
                        secondVideo.load();
                        if(videoSource[videoCount].ticker_text != "undefined")
                        {
                            if (videoSource[videoCount].ticker_text != null) {
                                if (videoSource[videoCount].video_type_id != 1) {
                        ...
                        videoUrl.onended = function() {
                            ...
                            if (videoCount == videoSource.length - 1 || videoSource.length == 0) {
                                ...
                                console.log('first', videoSource[videoCount], videoCount)
